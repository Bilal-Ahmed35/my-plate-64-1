// // 🌐 LibreTranslate Free Setup (No API Key Needed)
...
// // Get supported languages (free instance only)
...
// LibreTranslate Configuration and Setup Guide
...
# Option 1: Use public LibreTranslate instance (free, no API key needed)
VITE_LIBRETRANSLATE_URL=https://libretranslate.de

# Option 2: Use libretranslate.com (requires API key)
# VITE_LIBRETRANSLATE_URL=https://libretranslate.com
# VITE_LIBRETRANSLATE_API_KEY=your-libretranslate-api-key

# Option 3: Self-hosted LibreTranslate instance
# VITE_LIBRETRANSLATE_URL=https://your-domain.com
# VITE_LIBRETRANSLATE_API_KEY=your-api-key (if required by your instance)

# Note: Some instances are free and don't require API keys
# Check the instance documentation for requirements
*/

// LibreTranslate utility functions and configuration
